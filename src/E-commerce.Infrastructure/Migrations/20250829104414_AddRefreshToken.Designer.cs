...
namespace E_commerce.Infrastructure.Migrations
{
    ...
    [Migration("20250829104414_AddRefreshToken")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PermissionRole", b =>
                {
                    b.Property<Guid>("PermisisonsId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("RolesId")
                        .HasColumnType("uuid");

                    b.HasKey("PermisisonsId", "RolesId");
            ...
            modelBuilder.Entity("PermissionRole", b =>
                {
                    b.HasOne("E_commerce.Domain.Entities.Permission", null)
                        .WithMany()
                        .HasForeignKey("PermisisonsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
